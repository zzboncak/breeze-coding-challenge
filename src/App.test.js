...
describe('<App />', () => {
    ...
    it('button should enable when csv uploads and data is good', () => {
        const wrapper = shallow(<App />);
        ...
        wrapper.setState({
            peopleToImport: [{
                data: {
                    "first_name": "Zachary",
                    "last_name": "Zboncak",
                    "email_address": "zachary.zboncak@gmail.com",
                    "status": "active"
                }
            }]
        });
        ...
        console.log(button1.prop('disabled'));
        expect(button1.prop('disabled')).toEqual('');
    });
});
